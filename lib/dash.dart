...
class _DashState extends State<Dash> {
  ...
  void _menuFetch123() async {
    ...
    var res88 =
        await coll88.findOne({'phone': sp.getString('phone'), 'isActive': 1});
...
//DateTime formattedDate = "${date.year}-${date.month}-${date.day}";
    ...
    var res1 = await coll1.find({
      'user': sp.getString('phone'),
      'date': {r'$gt': DateTime(now.year, now.month, now.day).toUtc()}
    }).toList();
    if (res1 == null) {
      _status = 'No data';
    } else {
    ...
    var res2 = await coll2.find({
      'user': sp.getString('phone'),
      'date': {r'$gt': DateTime(now.year, now.month, 01).toUtc()}
    }).toList();
    print(res2);
    if (res2 == null) {
      _status = 'No data';
    ...
    var res3 = await coll3.find({
      'parent': sp.getString('phone'),
      'date': {r'$gt': DateTime(now.year, now.month, 01).toUtc()}
    }).toList();
                        ...
                        child: RaisedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      Dashboard(title: null, pageIndex: 10)));
                            },
                            child: Text(
                              'IDCARD',
                      ...
                      child: Container(
                        ...
                        child: RaisedButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      Dashboard(title: null, pageIndex: 11)));
                            },
                            child: Text(
                              'Offer letter',
                              style: TextStyle(color: Colors.teal),
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (builder) => Dashboard(pageIndex: 0,)));
                    },
                    child: Icon(
                      Icons.refresh,
                      color: Colors.teal,
                                              ...
                                              Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  crossAxisAlignment:
                                                      CrossAxisAlignment.center,
                                                  children: [
                                                    Text('Todays Achivement',
                                                        style: TextStyle(
                                                            fontSize: 10,
                                                            color: Colors
                                                                .teal[300])),
                                                    Text(todaytarget.toString(),
                                                        style: TextStyle(
                                                            fontSize: 40,
                                                            color: Colors.teal,
                                                            fontWeight:
                                                    ...
                                                    child: Column(
                                                      ...
                                                      crossAxisAlignment:
                                                          CrossAxisAlignment
                                                              .center,
                                                      children: [
                                                        Text('Month Achivement',
                                                            style: TextStyle(
                                                                fontSize: 10,
                                                                color:
                                                                    Colors.teal[
                                                                        300])),
                                                        Text(mtarget.toString(),
                                                            style: TextStyle(
                                                                fontSize: 40,
                                                                color:
                                                                    Colors.teal,
