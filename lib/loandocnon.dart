...
class LoanDocNon extends StatefulWidget {
  String title;
  String param;
  LoanDocNon({
    Key? key,
  ...
  @override
  _LoanDocNonState createState() => _LoanDocNonState();
}

class _LoanDocNonState extends State<LoanDocNon> {
  File? _image;
  ...
  upload7(File imageFile) async {
    ...
    // string to uri
    var uri = Uri.parse(imgserver + "upload7");
  ...
  upload8(File imageFile) async {
    ...
    // string to uri
    var uri = Uri.parse(imgserver + "upload8");
  ...
  fetch1() async {
    ...
    // fetch1();
    // var uri1 = Uri.parse(imgserver + "image1");
    // var response = await http.post(uri1, body: {"phone": widget.param, "subMenu": widget.title});
    // result1 = jsonDecode(response.body);
    // print(result[0]['aadharback']);
    // setState(() {
    //   isloaded = true;
    // });
  }
            ...
            children: [
              ...
              isloaded
                  ? Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(15.0),
                        child: result1['officeaddr'] == null
                            ? Text('X')
                            : Image.network(
                                imgserver + '${result1['officeaddr']}',
                                height: 100,
                              ),
                      ),
                    )
            ...
            children: [
              ...
              isloaded
                  ? Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(15.0),
                        child: result1['business'] == null
                            ? Text('X')
                            : Image.network(
                                imgserver + '${result1['business']}',
                                height: 100,
                              ),
                      ),
                    )
